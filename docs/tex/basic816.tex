...
\begin{document}
    ...
    Although not an edit key, the BREAK key is currently assigned as a ``programmer's key'' and will interrupt
    the currently running BASIC program and open the monitor, if you press it with the ALT key.
    It should work for any program (even machine language), so
